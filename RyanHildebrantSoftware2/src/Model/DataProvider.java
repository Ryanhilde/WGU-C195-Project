...
public class DataProvider {
    ...
    public static ObservableList<Customer> getAllCustomers() throws SQLException {
        ...
        while(customerResults.next()) {
            ...
            Customer customer = new Customer(customerResults.getInt("customerId"), customerResults.getString("customerName"), customerResults.getString("address"), customerResults.getString("city"), customerResults.getString("country"), customerResults.getString("postalCode"), customerResults.getString("phone"));
    ...
    public static ObservableList<Appointment> getAllAppointments() throws SQLException {
        ...
        Statement statement = DBConnection.getConnection().createStatement();
        String appointmentQuery = "SELECT customer.customerName, appointment.appointmentId, customer.customerId, user.userId, appointment.title, appointment.description, appointment.location, appointment.contact, appointment.type, appointment.url, appointment.start, appointment.end"
        ...
        while(appointmentResults.next()) {
            ...
            Appointment appointment = new Appointment(appointmentResults.getString("customerName"), appointmentResults.getInt("appointmentId"), appointmentResults.getInt("customerId"), appointmentResults.getInt("userId"), appointmentResults.getString("title"), appointmentResults.getString("description"),
            appointmentResults.getString("location"), appointmentResults.getString("contact"), appointmentResults.getString("type"), appointmentResults.getString("url"), appointmentResults.getString("start"), appointmentResults.getString("end"));
    ...
    public static void populateAppointmentTable() { 
        ...
        try {
            ...
            ResultSet selectAppointment = statement.executeQuery("SELECT appointmentId FROM appointment");
            ...
            for (int appointmentIDLoop : appointmentIDArray) {
                ...
                ResultSet appointmentTableData = statement.executeQuery("SELECT customer.customerName, appointmentId, appointment.customerId, userId, title, description, location, contact, type, url, start, end FROM appointment JOIN customer ON customer.customerId = appointment.customerId WHERE appointmentId = " + appointmentIDLoop);
                ...
                ZonedDateTime convertedStartTime = zonedStartLocal.withZoneSameInstant(localZoneId);
                ZonedDateTime convertedEndTime = zonedEndLocal.withZoneSameInstant(localZoneId);
    ...
    public static void setSelectedAppointmentsForCustomer(int selectedCustomer) {
        ...
        try {
            ...
            Statement statement = DBConnection.getConnection().createStatement();
            ResultSet selectedAppointments = statement.executeQuery("SELECT * FROM appointment WHERE customerId =" + selectedCustomer);
            ...
            while(selectedAppointments.next()) {
                ...
                ResultSet associatedAppointments = statement.executeQuery("SELECT customerId, appointmentId, location, start FROM appointment WHERE customerId =" + selectedCustomer);
    ...
    public static void setMonthlyView (String monthForReference) {
        ...
        try {
            ...
            Statement statement = DBConnection.getConnection().createStatement();
            ResultSet monthlyAppointments = statement.executeQuery("SELECT appointmentId FROM appointment WHERE monthname(start) = '" + monthForReference + "'");
